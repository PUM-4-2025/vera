...
list(APPEND _cmake_import_check_files_for_zlib "${_IMPORT_PREFIX}/x64/mingw/staticlib/libzlib.a" )
...
set_target_properties(libjpeg-turbo PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/x64/mingw/staticlib/liblibjpeg-turbo.a"
  )

list(APPEND _cmake_import_check_targets libjpeg-turbo )
list(APPEND _cmake_import_check_files_for_libjpeg-turbo "${_IMPORT_PREFIX}/x64/mingw/staticlib/liblibjpeg-turbo.a" )
...
list(APPEND _cmake_import_check_files_for_libtiff "${_IMPORT_PREFIX}/x64/mingw/staticlib/liblibtiff.a" )
...
list(APPEND _cmake_import_check_files_for_libwebp "${_IMPORT_PREFIX}/x64/mingw/staticlib/liblibwebp.a" )
...
set_target_properties(libopenjp2 PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/x64/mingw/staticlib/liblibopenjp2.a"
  )

list(APPEND _cmake_import_check_targets libopenjp2 )
list(APPEND _cmake_import_check_files_for_libopenjp2 "${_IMPORT_PREFIX}/x64/mingw/staticlib/liblibopenjp2.a" )
...
list(APPEND _cmake_import_check_files_for_libpng "${_IMPORT_PREFIX}/x64/mingw/staticlib/liblibpng.a" )
...
list(APPEND _cmake_import_check_files_for_IlmImf "${_IMPORT_PREFIX}/x64/mingw/staticlib/libIlmImf.a" )
...
set_target_properties(libprotobuf PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/x64/mingw/staticlib/liblibprotobuf.a"
  )

list(APPEND _cmake_import_check_targets libprotobuf )
list(APPEND _cmake_import_check_files_for_libprotobuf "${_IMPORT_PREFIX}/x64/mingw/staticlib/liblibprotobuf.a" )
...
list(APPEND _cmake_import_check_files_for_ade "${_IMPORT_PREFIX}/x64/mingw/staticlib/libade.a" )

# Import target "opencv_core" for configuration "Release"
set_property(TARGET opencv_core APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(opencv_core PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/x64/mingw/staticlib/libopencv_core4120.a"
  )

list(APPEND _cmake_import_check_targets opencv_core )
list(APPEND _cmake_import_check_files_for_opencv_core "${_IMPORT_PREFIX}/x64/mingw/staticlib/libopencv_core4120.a" )

# Import target "opencv_imgproc" for configuration "Release"
set_property(TARGET opencv_imgproc APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(opencv_imgproc PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/x64/mingw/staticlib/libopencv_imgproc4120.a"
  )

list(APPEND _cmake_import_check_targets opencv_imgproc )
list(APPEND _cmake_import_check_files_for_opencv_imgproc "${_IMPORT_PREFIX}/x64/mingw/staticlib/libopencv_imgproc4120.a" )

# Import target "opencv_imgcodecs" for configuration "Release"
set_property(TARGET opencv_imgcodecs APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(opencv_imgcodecs PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/x64/mingw/staticlib/libopencv_imgcodecs4120.a"
  )

list(APPEND _cmake_import_check_targets opencv_imgcodecs )
list(APPEND _cmake_import_check_files_for_opencv_imgcodecs "${_IMPORT_PREFIX}/x64/mingw/staticlib/libopencv_imgcodecs4120.a" )

# Import target "opencv_highgui" for configuration "Release"
set_property(TARGET opencv_highgui APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(opencv_highgui PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/x64/mingw/staticlib/libopencv_highgui4120.a"
  )

list(APPEND _cmake_import_check_targets opencv_highgui )
list(APPEND _cmake_import_check_files_for_opencv_highgui "${_IMPORT_PREFIX}/x64/mingw/staticlib/libopencv_highgui4120.a" )
